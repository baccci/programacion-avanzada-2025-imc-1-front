  ...
  return (
    <CalendarGridRac>
      <CalendarGridHeaderRac>
        {(day) => (
          <CalendarHeaderCellRac className="text-input-bg/50 size-9 rounded-md p-0 text-xs font-medium">
            {day}
      ...
      <CalendarGridBodyRac className="[&_td]:px-0 [&_td]:py-px">
        {(date) => (
          <CalendarCellRac
            date={date}
            className={cn(
              `text-input-bg data-hovered:bg-input-black-bg data-selected:bg-jordy-blue-600 data-hovered:text-input-bg/80 
              data-selected:text-primary-foreground data-focus-visible:ring-ring/50 relative flex size-9 
              items-center justify-center rounded-md p-0 text-sm font-normal whitespace-nowrap 
              ...
              data-unavailable:opacity-30 data-hovered:cursor-pointer data-selected:font-semibold`,
